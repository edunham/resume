...
\def \whitespaciness { 2pt } % bigger numbers = emptier page
\def \typeoffill {\dotfill} % hfill makes blank, dotfill makes dotted,
...
\newcommand{\squish}{
    \setlength{\itemsep}{\whitespaciness}
    \setlength{\parskip}{\whitespaciness}
    \setlength{\parsep}{\whitespaciness}
}
...
\newcommand{\CPP}{
    \hspace{-.05em}\raisebox{.4ex}{\tiny\bf +}\hspace{-.10em}\raisebox{.4ex}{\tiny\bf +}
}
