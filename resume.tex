...
% use section command instead, better underlining & there's a thing to
% squish space after
% redefining section: 
% might need makeatletter and makeatother
%        - might be itemize but not description
% beforeskip or afterskip
% google \renewcommand baselinestretch
% minipages?? CV
