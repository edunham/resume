...
% place, title, start when, end date
\newcommand{\experience}[3]{
\item[{#1}, \emph{#2}]
    \when{#3}
}

% conference name, when
...
\skill{Development}{Python, C/C++, Go, Ruby, HTML/CSS/Javascript}
\skill{Systems Administration}{Chef, Puppet, CFengine, Apache, Mailman,
    Jenkins, TravisCI, DNS}
\skill{Open-Source Workflow}{IRC, Git, SSH/SFTP, Markdown, ReStructuredText, 
    Sphinx}
\skill{Robotics}{Mechanical design, prototyping, OpenCV, Arduino development}
\skill{Leadership}{Documentation, teaching, public speaking, writing curricula}
